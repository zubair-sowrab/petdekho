    ...
    <View style={styles.container}>
      ...
      <ScrollView bounces={false}>
        <View style={styles.home}>
          <Text style={styles.text1}>Welcome to PetDekho!</Text>
          <View style={styles.view1}>
            <View style={styles.view8}>
              <Text style={styles.text2}>First Ever Pet Transport System in Bangladesh !</Text>
              
              <TouchableOpacity onPress={()=>{navigation.navigate("RequestScreen")}}>
              <View style={styles.button1}>
                <Text style={styles.button1Text}>Book Ride</Text>
            ...
            <View>
              ...
              source={require('../../assets/catcar.png')}></Image>
            </View>
          </View>
